...
class Products extends Controller {
    ...
    public function grains() {
        ...
        $this->view->productos = $this->model->productos($lng, 2);
    ...
    public function oils() {
        ...
        $this->view->productos = $this->model->productos($lng, 3);
    ...
    public function flours() {
        ...
        $this->view->header = $this->model->header($lng, 4);
        $this->view->productos = $this->model->productos($lng, 4);
